...
class Ui_CalibrationDialog(object):
    def setupUi(self, CalibrationDialog):
        ...
        self.UpdateScale_button.setGeometry(QtCore.QRect(10, 306, 381, 27))
        self.UpdateScale_button.setObjectName("UpdateScale_button")
        self.NewScale_label = QtWidgets.QLabel(CalibrationDialog)
        self.NewScale_label.setGeometry(QtCore.QRect(11, 230, 161, 20))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.NewScale_rollbox.setGeometry(QtCore.QRect(177, 223, 76, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.label_9.setGeometry(QtCore.QRect(264, 229, 121, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, CalibrationDialog):
        ...
        self.UpdateScale_button.setText(_translate("CalibrationDialog", "Update Scale"))
